        ...
        <div style={{ backgroundColor: '#f0a202', padding: '45px' }} >
            ...
            <div className="searchdiv" >
                ...
                <div style={{ margin: '40px 40px 0px 40px' }} >
                    ...
                    <h1 className="mainh1" style={{ padding: '20px 45px 45px 45px', color: 'white' }} > What type of web developer are you searchingfor ? </h1>
                    ...
                    <div className='searchbuttons'>
                        ...
                        <a
                            ...
                            href='#frontenddevs' > Front - end
                        </a>

                        <a
                            name='backend'
                            className="search-but"
                            href='#backenddevs' > Back - end
                        </a>

                        <a
                            name='fullstack'
                            className="search-but"
                            href='#fullstackdevs' > Full - stack
                        </a>
                    </div>
            ...
            <div className='searchresults'>
                ...
                <div className='sr' >
                    ...
                    <h1 className='mainh1'
                        ...
                        id='frontenddevs' > Front - End Developers :
                    </h1>
                ...
                <div className='sr' >
                    <h1 className='mainh1'
                        style={{ marginTop: '25px', color: 'white' }}
                        id='backenddevs' > Back - End Developers:
                    </h1>
                ...
                <div className='sr' >
                    <h1 className='mainh1'
                        style={{ marginTop: '25px', color: 'white' }}
                        id='fullstackdevs' > Full - Stack Developers:
                    </h1>
