...
export default function Main() {
    ...
    return ( <
        ...
        div className = "hero"
        style = {
            { position: 'relative', textAlign: 'center', backgroundColor: '#F0A202' } } >
        <
        img src = { heroimg }
        alt = "coder"
        style = {
            { maxWidth: '100%', height: 'auto', padding: '20px' } }
        />                 {
            Auth.loggedIn() ? ([ <
                >
                <
        ...
        h1 className = "mainh1" > About < span style = {
            { fontStyle: "italic", fontWeight: '400' } } > Find My Coder < /span></h
        1 >
        <
        ...
        p className = 'pmain'
        style = {
            { textAlign: 'center', paddingTop: '20px' } } > Here are some of our talented developers ready
        for hire: < /p> <
        ...
        p className = 'pmain'
        style = {
            { padding: '30px', color: '#294a66', fontSize: '35px', marginBottom: '30px' } } > Here are some testimonials from developers and companies that have worked with us in the past: < /p> <
