        ...
        <div style={
            ...
            <div style={
                ...
                <h2 className='mainh1' > About < span style={
                    { fontWeight: 'bold' }} > Coder Finder </span></h2 >
            </div> <div style={
                ...
                <Row style={
                    ...
                    <Card style={
                        ...
                        <Card.Body >
                            ...
                            <Card.Text style={
                                ...
                                None– It’ s a hardware problem " </Card.Text>
                            <Row >
                                <div style={
                                    ...
                                    <a rel="noreferrer" 
                                        href='https://www.linkedin.com/in/carissa-mero-91333813a/'
                                        target='_blank' >
                                        <AiFillLinkedin style={
                                            { marginLeft: '15px' }} />
                                    </a> </div> </Row> </Card.Body> </Card>
                    ...
                    <Card style={
                        ...
                        <Card.Body >
                            ...
                            <Card.Text style={
                                ...
                                Because Oct 31 equals Dec 25. " </Card.Text>
                            <Row >
                                <div style={
                                    { color: 'black', fontSize: '50px', textAlign: 'center' }} >
                                    <a href='https://www.GitHub.com/kekehua' rel= "noreferrer" >
                                        <AiFillGithub style={
                                            { marginRight: '15px' }}
                                        />
                                    </a>
                    ...
                    <Card style={
                        ...
                        <Card.Body >
                            ...
                            <Card.Text style={
                                { color: 'black' }} >
                                Front - end web developer. </Card.Text>
                            <Row >
                                <div style={
                                    { color: 'black', fontSize: '50px', textAlign: 'center' }} >
                                    <a href='https://github.com/avii004'
